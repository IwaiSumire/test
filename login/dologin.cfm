...
<cfif validateUser.secureid is not ""><!---あったとき--->
    ...
    <cflock scope="session" timeout="10" type="EXCLUSIVE"><!---セッション変数にsecureidをセット---><!---EXCLUSIVE：排他的ロック--->
        <cfset session.secureid = validateUser.secureid><!---セッションidはログインしようとしたsecureid--->
    </cflock>
